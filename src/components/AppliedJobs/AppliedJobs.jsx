          ...
          <div className="my-10">
            <div className="text-right mb-5">
              <button
                ...
                className="px-6 py-2 bg-slate-100 hover:bg-slate-200 border-2 rounded text-xs font-semibold text-slate-400"
              >
                Remote Job
              </button>
              <button
                onClick={handleFilterOnsiteJobs}
                className="ml-3 px-6 py-2 bg-slate-100 hover:bg-slate-200 border-2 rounded text-xs font-semibold text-slate-400"
              >
                Onsite Job
              </button>
            </div>
