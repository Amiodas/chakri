function Banner() {
  return (
    <div className="container mx-auto px-5 flex py-8">
      <div className="flex-auto">
        ...
        <p className="text-slate-600 pt-8">
          ...
          need. Its your future. Come find it. Manage all your job <br /> application
      ...
      <div className="flex justify-end flex-auto">
        <img className="w-auto h-96" src="/src/assets/assets/All Images/P3OLGJ1 copy 1.png" />
      </div>
    </div>
  );
}
